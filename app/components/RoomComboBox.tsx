...
const rooms = [
  { id: 1, name: "Multipurpose 1", unavailable: false },
  { id: 2, name: "Multipurpose 2", unavailable: false },
  { id: 3, name: "Multipurpose 3", unavailable: false },
  { id: 4, name: "Multipurpose 4", unavailable: true },
  { id: 5, name: "Meeting Room 1", unavailable: false },
  { id: 6, name: "Meeting Room 2", unavailable: true },
];
      ...
      <Listbox value={selectedRoom} onChange={setSelectedRoom}>
        <div className="relative mt-1">
          <Listbox.Button className="relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-blue-300 sm:text-sm">
            <span className="block truncate">{selectedRoom.name}</span>
