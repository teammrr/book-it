      ...
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500">
            Crafted with 💙 by{" "}
            <a
              className="font-semibold text-[#1b4c82] hover:text-[#2a4460] dark:text-blue-500 dark:hover:text-blue-400"
              href="#"
            >
              Teamrr
            </a>{" "}
          ...
          <p className="text-gray-500">
            Copyright © 2024 BookIt, All rights reserved.
          </p>
        </div>
